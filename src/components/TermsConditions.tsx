  ...
  return (
    <div className='relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]'>
      <div className='relative mx-auto max-w-[37.5rem] pt-20 text-center pb-24'>
        <h1 className='text-4xl  dark:text-white font-extrabold tracking-tight text-slate-900 sm:text-5xl'>
          Terms and Conditions
        </h1>
        <p className='mt-4 dark:text-white text-base leading-7 text-slate-600'>
        ...
        <div className='mx-auto max-w-[40rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600'>
          ...
          <ul className='list-disc list-inside mb-4'>
            ...
            <li className='mb-4'>
              ...
              in this Agreement) refers to My Content Blog.
            </li>
            <li className='mb-4'>
            ...
            <li className='mb-4'>
              <strong>Website</strong> refers to My Content Blog, accessible
              from{" "}
              <a
                href='https://mycontentblog.netlify.app/'
                rel='external nofollow noopener'
                target='_blank'
              >
                https://mycontentblog.netlify.app/
              </a>
            </li>
            <li className='mb-4'>
          ...
          <ul>
            <li>
              ...
              <a
                href='https://mycontentblog.netlify.app/contact'
                rel='external nofollow noopener'
                target='_blank'
              >
                https://mycontentblog.netlify.app/contact
              </a>
            </li>
          </ul>
        </div>
